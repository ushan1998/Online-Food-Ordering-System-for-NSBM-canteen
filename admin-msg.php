...
$query = "SELECT * FROM public_messeges";
...
if ($users) {
  ...
  while ($user = mysqli_fetch_assoc($users)) {
    ...
    $public_msg .= "<tr>";
        ...
        $public_msg .= "<td>{$user['public_name']}</td>";
        $public_msg .= "<td>{$user['public_email']}</td>";
        $public_msg .= "<td>{$user['public_msg']}</td>";
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="page-header">
              <h3>Public Messeges <small>National School of Bussines Managment Food Ordering System</small></h3>
        </div>
