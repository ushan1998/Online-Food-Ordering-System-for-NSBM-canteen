...
$query = "SELECT * FROM users WHERE is_deleted=0 ORDER BY user_name";
...
if ($users) {
  ...
  while ($user = mysqli_fetch_assoc($users)) {
    ...
    $user_list .= "<tr>";
        ...
        $user_list .= "<td>{$user['user_tell']}</td>";

      //  $user_list .= "<td>{$user['last_login']}</td>";

      // $user_list .= "<td><a href=\"modify-user.php?user_id={$user['user_id']}\">Edit</a></td>";
      // $user_list .= "<td><a href=\"delete-user.php?user_id={$user['user_id']}\">Delete</a></td>";
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="page-header">
              <h3>Administrative Users <small>National School of Bussines Managment Food Ordering System</small></h3>
        </div>
