...
if ($users) {
  ...
  while ($user = mysqli_fetch_assoc($users)) {
    ...
    $online_orders .= "<tr>";
        ...
        $online_orders .= "<td>{$user['online_name']}</td>";
        $online_orders .= "<td>{$user['online_address']}</td>";
        $online_orders .= "<td>{$user['online_tell']}</td>";
        $online_orders .= "<td>{$user['online_date']}</td>";
        $online_orders .= "<td>{$user['online_payement_method']}</td>";
        $online_orders .= "<td>{$user['online_card_type']}</td>";
        $online_orders .= "<td>{$user['online_card_number']}</td>";
        $online_orders .= "<td>{$user['online_meal']}</td>";
        $online_orders .= "<td>{$user['online_qty']}</td>";
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="page-header">
              <h3>Online Customer Orders <small>National School of Bussines Managment Food Ordering System</small></h3>
        </div>
