    ...
    <div class="row">
      <div class="col-md-3">
        <div class="list-group">
            <a href="" class="list-group-item list-group-item-success"><span class="glyphicon glyphicon-user" aria-hidden="true" style="padding-right:5px;"></span>Admin 
      ...
      <div class="col-md-9">
        <div class="page-header">
              <h3>Add a Order <small>National School of Bussines Managment Food Ordering System</small></h3>
        </div>

        <form style="margin-right:20px;" action="order-add.php" method="POST">
            <div class="form-group">
                <label for="ordername">Name :</label>
                <input type="text" class="form-control" name="ordername" placeholder="name" required>
            </div>
            <div class="form-group">
                <label for="orderaddress">Address :</label>
                <input type="text" class="form-control" name="orderaddress" placeholder="address" required>
            </div>

            <div class="form-group">
                <label for="orderrell">Telephone no :</label>
                <input type="number" class="form-control" name="ordertell" placeholder="telephone number" required>
            </div>
           ...
           <h2>Event Details</h2>
            ...
            <label for="paymentmethods">Payment Method :</label>
                ...
                <div class="enterthecard-number" style="padding-top:20px;">
                    <div class="form-group">
                        <label for="cardnumber">Enter the QTY :</label>
                        <input type="number" class="form-control" name="foodqty" maxlength="20" required>
                    </div>
                </div>
