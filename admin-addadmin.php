    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="page-header">
              <h3>Add a Administrative Account <small>National School of Bussines Managment Food Ordering System</small></h3>
        </div>

        <form style="margin-right:20px;" action="user-signin.php" method="POST">
            ...
            <div class="form-group">
                <label for="adminemail">E-maill address :</label>
                <input type="email" class="form-control" name="adminemail" placeholder="address" required>
            </div>

            <div class="form-group">
                <label for="admintell">Telephone no :</label>
                <input type="number" class="form-control" name="admintell" placeholder="telephone number" required>
            </div>
