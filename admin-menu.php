    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="page-header">
              <h3>Menu <small>National School of Bussines Managment Food Ordering System</small></h3>
        </div>
          <div class="menu">
           ...
           <tr>
               ...
               <td>Rs 100/=</td>
              <td> <button type="button" class="btn btn-danger btn-xs">order now</button></td>
           ...
           <tr>
               ...
               <td>Rs 150/=</td>
               <td>
                   <button type="button" class="btn btn-danger btn-xs">order now</button>
               </td>
